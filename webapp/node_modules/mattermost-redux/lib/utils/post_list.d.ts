...
export declare function makeFilterPostsAndAddSeparators(): import("mattermost-redux/selectors/create_selector").OutputParametricSelector<GlobalState, PostFilterOptions, string[], (res1: Post[], res2: number, res3: boolean | undefined, res4: string, res5: UserProfile, res6: boolean) => string[]>;
export declare function makeAddDateSeparatorsForSearchResults(): import("mattermost-redux/selectors/create_selector").OutputParametricSelector<GlobalState, Post[], (string | Post)[], (res1: Post[], res2: UserProfile) => (string | Post)[]>;
