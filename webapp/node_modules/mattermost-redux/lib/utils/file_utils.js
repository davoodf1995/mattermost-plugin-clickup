...
function getFileType(file) {
    ...
    return fileTypes.find((fileType) => {
        ...
        const fileTypeExts = constants_1.Files[constForFileTypeExtList];
...
function getFileMiniPreviewUrl(fileInfo) {
    if (!fileInfo?.mini_preview || !fileInfo?.mime_type) {
        return undefined;
    }
    return `data:${fileInfo.mime_type};base64,${fileInfo.mini_preview}`;
}
function sortFileInfos(fileInfos = [], locale = constants_1.General.DEFAULT_LOCALE) {
