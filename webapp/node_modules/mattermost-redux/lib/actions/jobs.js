...
function createJob(job) {
    return (0, helpers_1.bindClientFunc)({
        ...
        onSuccess: action_types_1.JobTypes.RECEIVED_JOB,
        params: [
            job,
        ],
    });
...
function getJobs(page = 0, perPage = constants_1.General.JOBS_CHUNK_SIZE) {
    return (0, helpers_1.bindClientFunc)({
        clientFunc: client_1.Client4.getJobs,
        onSuccess: action_types_1.JobTypes.RECEIVED_JOBS,
        params: [
            page,
            perPage,
        ],
