...
function isLimitedResults(state = -1, action) {
    switch (action.type) {
        case action_types_1.SearchTypes.SEARCH_POSTS_REQUEST: {
            if (!action.isGettingMore) {
                return -1;
...
function truncationInfo(state = { posts: 0, files: 0 }, action) {
    switch (action.type) {
        case action_types_1.SearchTypes.RECEIVED_SEARCH_TRUNCATION_INFO: {
