...
exports.managedCategoryMappings = managedCategoryMappings;
...
function byId(state = {}, action) {
    switch (action.type) {
        ...
        case action_types_1.ChannelTypes.GM_CONVERTED_TO_CHANNEL: {
            ...
            const receivedChannel = action.data;
            const newState = {};
    ...
    switch (action.type) {
        ...
        case action_types_1.ChannelCategoryTypes.CATEGORY_DELETED: {
            ...
            for (const teamId of Object.keys(nextState)) {
                ...
                nextState[teamId] = (0, array_utils_1.removeItem)(state[teamId], categoryId);
            }
            return nextState;
        }
        case action_types_1.TeamTypes.LEAVE_TEAM: {
...
function managedCategoryMappings(state = {}, action) {
    switch (action.type) {
        case action_types_1.ChannelCategoryTypes.RECEIVED_MANAGED_CATEGORY_MAPPINGS: {
            return {
                ...state,
                [action.data.team_id]: action.data.mappings,
            };
        }
        case action_types_1.ChannelCategoryTypes.MANAGED_CATEGORY_MAPPING_SET: {
            return {
                ...state,
                [action.data.team_id]: {
        ...
        case action_types_1.ChannelCategoryTypes.MANAGED_CATEGORY_MAPPING_REMOVED:
        case action_types_1.ChannelTypes.LEAVE_CHANNEL: {
