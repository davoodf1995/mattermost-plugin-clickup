...
export type PostReaction = BaseWebSocketMessage<WebSocketEvents.ReactionAdded | WebSocketEvents.ReactionRemoved, {
    reaction: JsonEncodedValue<Reaction>;
}>;
export type PostAcknowledgement = BaseWebSocketMessage<WebSocketEvents.PostAcknowledgementAdded | WebSocketEvents.PostAcknowledgementRemoved, {
    acknowledgement: JsonEncodedValue<PostAcknowledgementType>;
}>;
export type PostDraft = BaseWebSocketMessage<WebSocketEvents.DraftCreated | WebSocketEvents.DraftUpdated | WebSocketEvents.DraftDeleted, {
    draft: JsonEncodedValue<Draft>;
}>;
export type PersistentNotificationTriggered = BaseWebSocketMessage<WebSocketEvents.PersistentNotificationTriggered, {
    post: JsonEncodedValue<Post>;
    channel_type: ChannelType;
    channel_display_name: string;
    channel_name: string;
...
export type ScheduledPost = BaseWebSocketMessage<WebSocketEvents.ScheduledPostCreated | WebSocketEvents.ScheduledPostUpdated | WebSocketEvents.ScheduledPostDeleted, {
...
export type ThreadReadChanged = BaseWebSocketMessage<WebSocketEvents.ThreadReadChanged, (Record<string, never>) | ({
    timestamp: number;
}) | ({
    thread_id: string;
    timestamp: number;
...
export type Team = BaseWebSocketMessage<WebSocketEvents.UpdateTeam | WebSocketEvents.DeleteTeam | WebSocketEvents.RestoreTeam, {
...
export type GroupAssociatedToTeam = BaseWebSocketMessage<WebSocketEvents.ReceivedGroupAssociatedToTeam | WebSocketEvents.ReceivedGroupNotAssociatedToTeam, {
    group_id: string;
}>;
export type GroupAssociatedToChannel = BaseWebSocketMessage<WebSocketEvents.ReceivedGroupAssociatedToChannel | WebSocketEvents.ReceivedGroupNotAssociatedToChannel, {
    group_id: string;
}>;
export type GroupMember = BaseWebSocketMessage<WebSocketEvents.GroupMemberAdded | WebSocketEvents.GroupMemberDeleted, {
...
export type PreferencesChanged = BaseWebSocketMessage<WebSocketEvents.PreferencesChanged | WebSocketEvents.PreferencesDeleted, {
...
export type FirstAdminVisitMarketplaceStatusReceived = BaseWebSocketMessage<WebSocketEvents.FirstAdminVisitMarketplaceStatusReceived, {
    firstAdminVisitMarketplaceStatus: JsonEncodedValue<boolean>;
}>;
export type HostedCustomerSignupProgressUpdated = BaseWebSocketMessage<WebSocketEvents.HostedCustomerSignupProgressUpdated, {
    progress: string;
}>;
...
export type ContentFlaggingReportValueUpdated = BaseWebSocketMessage<WebSocketEvents.ContentFlaggingReportValueUpdated, {
