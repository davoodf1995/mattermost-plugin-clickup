...
class Client4 {
    ...
    updateUserAuth = (userId, userAuth) => {
        return this.doFetch(`${this.getUserRoute(userId)}/auth`, { method: 'put', body: JSON.stringify(userAuth) });
    };
    ...
    loginWithMagicLink = (token) => {
        ...
        return this.doFetch(`${this.getUsersRoute()}/login/one_time_link`, { method: 'post', body: JSON.stringify(body) });
    };
    getUserLoginType = (loginId) => {
        const body = {
            login_id: loginId,
        };
        return this.doFetch(`${this.getUsersRoute()}/login/type`, { method: 'post', body: JSON.stringify(body) });
    };
    logout = async () => {
    ...
    authorizeOAuthApp = (responseType, clientId, redirectUri, state, scope, resource, codeChallenge, codeChallengeMethod) => {
        const body = { client_id: clientId, response_type: responseType, redirect_uri: redirectUri, state, scope };
        ...
        return this.doFetch(`${this.url}/oauth/authorize`, { method: 'post', body: JSON.stringify(body) });
    };
    ...
    getTeam = (teamId, asContentReviewer = false, flaggedPostId) => {
        ...
        return this.doFetch(`${this.getTeamRoute(teamId)}${queryParams}`, { method: 'get' });
    };
    ...
    sendEmailGuestInvitesToChannelsGracefully = async (teamId, channelIds, emails, message, guestMagicLink = false) => {
        const queryParams = new URLSearchParams({ graceful: 'true' });
        if (guestMagicLink) {
            queryParams.append('guest_magic_link', 'true');
        }
        return this.doFetch(`${this.getTeamRoute(teamId)}/invite-guests/email?${queryParams.toString()}`, { method: 'post', body: JSON.stringify({ emails, channels: channelIds, message }) });
    };
    ...
    setMyChannelAutotranslation = (channelId, enabled) => {
        return this.doFetch(`${this.getChannelMemberRoute(channelId, 'me')}/autotranslation`, { method: 'put', body: JSON.stringify({ autotranslation_disabled: !enabled }) });
    };
    ...
    getChannel = (channelId, asContentReviewer = false, flaggedPostId) => {
        const queryParamsArgs = {};
        if (asContentReviewer) {
            queryParamsArgs.as_content_reviewer = true;
        }
        ...
        const queryParams = (0, helpers_1.buildQueryString)(queryParamsArgs);
        return this.doFetch(`${this.getChannelRoute(channelId)}${queryParams}`, { method: 'get' });
    };
    ...
    getManagedCategories = (teamId) => {
        return this.doFetch(`${this.getTeamRoute(teamId)}/channels/managed_categories`, { method: 'get' });
    };
    getPropertyFields = (groupName, objectType, targetType) => {
        return this.doFetch(`${this.getBaseRoute()}/properties/groups/${groupName}/${objectType}/fields?target_type=${targetType}`, { method: 'get' });
    };
    getPropertyValues = (groupName, objectType, targetId) => {
        return this.doFetch(`${this.getBaseRoute()}/properties/groups/${groupName}/${objectType}/values/${targetId}`, { method: 'get' });
    };
    ...
    getRemoteClusters = (options = {}) => {
        ...
        return this.doFetch(`${this.getRemoteClustersRoute()}${(0, helpers_1.buildQueryString)(params)}`, { method: 'GET' });
    };
    ...
    getRemoteClusterInfo = (remoteId, includeDeleted) => {
        return this.doFetch(`${this.getBaseRoute()}/sharedchannels/remote_info/${remoteId}${(0, helpers_1.buildQueryString)({ include_deleted: includeDeleted })}`, { method: 'GET' });
    };
    ...
    updateUserCustomProfileAttributesValues = (userID, attributeValues) => {
        return this.doFetch(`${this.getUserRoute(userID)}/custom_profile_attributes`, { method: 'PATCH', body: JSON.stringify(attributeValues) });
    };
    ...
    getPost = (postId, includeDeleted, retainContent) => {
        return this.doFetch(`${this.getPostRoute(postId)}${(0, helpers_1.buildQueryString)({ include_deleted: includeDeleted, retain_content: retainContent })}`, { method: 'get' });
    };
    patchPost = (postPatch) => {
    ...
    revealBurnOnReadPost = (postId) => {
        return this.doFetch(`${this.getPostRoute(postId)}/reveal`, { method: 'get' });
    };
    burnPostNow = (postId) => {
    ...
    lookupInteractiveDialog = (data) => {
        return this.doFetch(`${this.getBaseRoute()}/actions/dialogs/lookup`, { method: 'post', body: JSON.stringify(data) });
    };
    // Emoji Routes
    ...
    getJobsByType = (type, page = 0, perPage = PER_PAGE_DEFAULT, teamId) => {
        const params = { page, per_page: perPage };
        if (teamId) {
            params.team_id = teamId;
        }
        return this.doFetch(`${this.getJobsRoute()}/type/${type}${(0, helpers_1.buildQueryString)(params)}`, { method: 'get' });
    };
    createJob = (job) => {
    ...
    // Recaps Routes
    createRecap = (request) => {
        return this.doFetch(`${this.getRecapsRoute()}`, { method: 'post', body: JSON.stringify(request) });
    };
    getRecaps = (page = 0, perPage = PER_PAGE_DEFAULT) => {
        return this.doFetch(`${this.getRecapsRoute()}${(0, helpers_1.buildQueryString)({ page, per_page: perPage })}`, { method: 'get' });
    };
    getRecap = (recapId) => {
        return this.doFetch(`${this.getRecapsRoute()}/${recapId}`, { method: 'get' });
    };
    markRecapAsRead = (recapId) => {
        return this.doFetch(`${this.getRecapsRoute()}/${recapId}/read`, { method: 'post' });
    };
    regenerateRecap = (recapId) => {
        return this.doFetch(`${this.getRecapsRoute()}/${recapId}/regenerate`, { method: 'post' });
    };
    deleteRecap = (recapId) => {
        return this.doFetch(`${this.getRecapsRoute()}/${recapId}`, { method: 'delete' });
    };
    // Admin Routes
    getLogs = (logFilter) => {
    ...
    // Agent Routes
    getAgents = () => {
        return this.doFetch(`${this.getAgentsRoute()}`, { method: 'get' });
    };
    getAgentsStatus = () => {
        return this.doFetch(`${this.getAgentsRoute()}/status`, { method: 'get' });
    };
    getLLMServices = () => {
        return this.doFetch(`${this.getBaseRoute()}/llmservices`, { method: 'get' });
    };
    ...
    getGroupsByNames = (names) => {
        return this.doFetch(`${this.getGroupsRoute()}/names`, { method: 'post', body: JSON.stringify(names) });
    };
    ...
    getCloudPreviewModalData = () => {
        return this.doFetch(`${this.getCloudRoute()}/preview/modal_data`, { method: 'get' });
    };
    getInvoices = () => {
    ...
    getAIRewrittenMessage = (agentId, message, action, customPrompt, rootId) => {
        const body = {
            agent_id: agentId,
            message,
        };
        ...
        return this.doFetch(`${this.getPostsRoute()}/rewrite`, { method: 'post', body: JSON.stringify(body) }).then((response) => response.rewritten_text);
    };
    // Client Helpers
    ...
    getAccessControlPolicy = (id, channelId, teamId) => {
    ...
    updateOrCreateAccessControlPolicy = (policy, teamId) => {
        const teamParam = teamId ? `?team_id=${encodeURIComponent(teamId)}` : '';
        return this.doFetch(`${this.getBaseRoute()}/access_control_policies${teamParam}`, { method: 'put', body: JSON.stringify(policy) });
    };
    deleteAccessControlPolicy = (id, teamId) => {
        const teamParam = teamId ? `?team_id=${encodeURIComponent(teamId)}` : '';
        return this.doFetch(`${this.getBaseRoute()}/access_control_policies/${id}${teamParam}`, { method: 'delete' });
    };
    getAccessControlPolicies = (after, limit) => {
        return this.doFetch(`${this.getBaseRoute()}/access_control_policies/search`, { method: 'post', body: JSON.stringify({ type: 'parent', cursor: { id: after }, limit, actions: ['membership'] }) });
    };
    ...
    getChannelsForAccessControlPolicy = (policyId, after, limit, teamId) => {
        const teamParam = teamId ? `&team_id=${encodeURIComponent(teamId)}` : '';
        return this.doFetch(`${this.getBaseRoute()}/access_control_policies/${policyId}/resources/channels?after=${after}&limit=${limit}${teamParam}`, { method: 'get' });
    };
    searchAccessControlPolicies = (term, type, after, limit, teamId) => {
        return this.doFetch(`${this.getBaseRoute()}/access_control_policies/search`, { method: 'post', body: JSON.stringify({ term, type, cursor: { id: after }, limit, include_children: true, ...(teamId && { team_id: teamId }) }) });
    };
    searchPermissionPolicies = (term, after, limit) => {
        return this.doFetch(`${this.getBaseRoute()}/access_control_policies/search`, { method: 'post', body: JSON.stringify({ term, type: 'permission', cursor: { id: after }, limit }) });
    };
    searchChildAccessControlPolicyChannels = (policyId, term, opts, teamId) => {
        const teamParam = teamId ? `?team_id=${encodeURIComponent(teamId)}` : '';
        return this.doFetch(`${this.getBaseRoute()}/access_control_policies/${policyId}/resources/channels/search${teamParam}`, { method: 'post', body: JSON.stringify({ term, ...opts }) });
    };
    assignChannelsToAccessControlPolicy = (policyId, channelIds, teamId) => {
        return this.doFetch(`${this.getBaseRoute()}/access_control_policies/${policyId}/assign`, { method: 'post', body: JSON.stringify({ channel_ids: channelIds, ...(teamId && { team_id: teamId }) }) });
    };
    unassignChannelsFromAccessControlPolicy = (policyId, channelIds, teamId) => {
        return this.doFetch(`${this.getBaseRoute()}/access_control_policies/${policyId}/unassign`, { method: 'delete', body: JSON.stringify({ channel_ids: channelIds, ...(teamId && { team_id: teamId }) }) });
    };
    createAccessControlSyncJob = (jobData) => {
        const job = {
    ...
    getAccessControlFields = (after, limit, channelId, teamId) => {
        ...
        return this.doFetch(`${this.getBaseRoute()}/access_control_policies/cel/autocomplete/fields?${params.toString()}`, { method: 'get' });
    };
    checkAccessControlExpression = (expression, channelId, teamId) => {
        const requestBody = { expression };
        if (channelId) {
        ...
        return this.doFetch(`${this.getBaseRoute()}/access_control_policies/cel/check`, { method: 'post', body: JSON.stringify(requestBody) });
    };
    testAccessControlExpression = (expression, term, after, limit, channelId, teamId) => {
        const requestBody = {
        ...
        return this.doFetch(`${this.getBaseRoute()}/access_control_policies/cel/test`, { method: 'post', body: JSON.stringify(requestBody) });
    };
    expressionToVisualFormat = (expression, channelId, teamId) => {
        const requestBody = { expression };
        if (channelId) {
            requestBody.channelId = channelId;
        }
        ...
        return this.doFetch(`${this.getBaseRoute()}/access_control_policies/cel/visual_ast`, { method: 'post', body: JSON.stringify(requestBody) });
    };
    validateExpressionAgainstRequester = (expression, channelId, teamId) => {
        const requestBody = { expression };
        ...
        return this.doFetch(`${this.getBaseRoute()}/access_control_policies/cel/validate_requester`, { method: 'post', body: JSON.stringify(requestBody) });
    };
    ...
    updateAccessControlPoliciesActive = (states, teamId) => {
        const body = { entries: states };
        if (teamId) {
            body.team_id = teamId;
        }
        return this.doFetch(`${this.getBaseRoute()}/access_control_policies/activate`, { method: 'put', body: JSON.stringify(body) });
    };
    getTeamContentFlaggingStatus = (teamId) => {
        return this.doFetch(`${this.getContentFlaggingRoute()}/team/${teamId}/status`, { method: 'get' });
    };
    getContentFlaggingConfig = (teamId) => {
        return this.doFetch(`${this.getContentFlaggingRoute()}/flag/config${(0, helpers_1.buildQueryString)({ team_id: teamId })}`, { method: 'get' });
    };
    flagPost = (postId, reason, comment) => {
        return this.doFetch(`${this.getContentFlaggingRoute()}/post/${postId}/flag`, {
            method: 'post',
            body: JSON.stringify({ reason, comment: JSON.stringify(comment) }),
        });
    };
    removeFlaggedPost = (postId, comment) => {
        return this.doFetch(`${this.getContentFlaggingRoute()}/post/${postId}/remove`, {
            method: 'put',
            body: JSON.stringify({ comment: JSON.stringify(comment) }),
        });
    };
    keepFlaggedPost = (postId, comment) => {
        return this.doFetch(`${this.getContentFlaggingRoute()}/post/${postId}/keep`, {
            method: 'put',
            body: JSON.stringify({ comment: JSON.stringify(comment) }),
        });
    };
    getPostContentFlaggingFields = () => {
        return this.doFetch(`${this.getContentFlaggingRoute()}/fields`, { method: 'get' });
    };
    getPostContentFlaggingValues = (postId) => {
        return this.doFetch(`${this.getContentFlaggingRoute()}/post/${postId}/field_values`, { method: 'get' });
    };
    getFlaggedPost = (postId) => {
        return this.doFetch(`${this.getContentFlaggingRoute()}/post/${postId}`, { method: 'get' });
    };
    searchContentFlaggingReviewers = (term, teamId) => {
        return this.doFetch(`${this.getContentFlaggingRoute()}/team/${teamId}/reviewers/search${(0, helpers_1.buildQueryString)({ term })}`, { method: 'get' });
    };
    setContentFlaggingReviewer = (postId, reviewerId) => {
        return this.doFetch(`${this.getContentFlaggingRoute()}/post/${postId}/assign/${reviewerId}`, { method: 'post' });
    };
    saveContentFlaggingConfig = (config) => {
        return this.doFetch(`${this.getContentFlaggingRoute()}/config`, { method: 'put', body: JSON.stringify(config) });
    };
    getAdminContentFlaggingConfig = () => {
        return this.doFetch(`${this.getContentFlaggingRoute()}/config`, { method: 'get' });
    };
}
