...
import type { Address, Product, CloudCustomer, CloudCustomerPatch, Invoice, Limits, NotifyAdminRequest, Subscription, ValidBusinessEmail, Installation, PreviewModalContentData } from '@mattermost/types/cloud';
import type { Compliance } from '@mattermost/types/compliance';
import type { ClientConfig, ClientLicense, DataRetentionPolicy, License, AdminConfig, EnvironmentConfig, RequestLicenseBody, AllowedIPRanges, AllowedIPRange, FetchIPResponse, LdapSettings, ContentFlaggingSettings } from '@mattermost/types/config';
...
import type { NameMappedPropertyFields, UserPropertyField, UserPropertyFieldPatch, PropertyValue, PropertyField } from '@mattermost/types/properties';
...
import type { AuthChangeResponse, UserAccessToken, UserAuthUpdate, UserProfile, UsersStats, UserStatus, GetFilteredUsersStatsOpts, UserCustomStatus } from '@mattermost/types/users';
...
export default class Client4 {
    ...
    getJobsRoute(): string;
    getRecapsRoute(): string;
    getPluginsRoute(): string;
    getAgentsRoute(): string;
    getLLMServicesRoute(): string;
    ...
    getContentFlaggingRoute(): string;
    ...
    updateUserAuth: (userId: string, userAuth: UserAuthUpdate) => Promise<UserAuthUpdate>;
    ...
    loginWithMagicLink: (token: string) => Promise<UserProfile>;
    getUserLoginType: (loginId: string) => Promise<{
    ...
    authorizeOAuthApp: (responseType: string, clientId: string, redirectUri: string, state: string, scope: string, resource?: string, codeChallenge?: string, codeChallengeMethod?: string) => Promise<void>;
    ...
    getTeam: (teamId: string, asContentReviewer?: boolean, flaggedPostId?: string) => Promise<Team>;
    ...
    sendEmailGuestInvitesToChannelsGracefully: (teamId: string, channelIds: string[], emails: string[], message: string, guestMagicLink?: boolean) => Promise<TeamInviteWithError[]>;
    ...
    setMyChannelAutotranslation: (channelId: string, enabled: boolean) => Promise<StatusOK>;
    updateChannelNotifyProps: (props: any) => Promise<StatusOK>;
    updateChannelScheme: (channelId: string, schemeId: string) => Promise<StatusOK>;
    getChannel: (channelId: string, asContentReviewer?: boolean, flaggedPostId?: string) => Promise<ServerChannel>;
    ...
    updateChannelBookmark: (channelId: string, channelBookmarkId: string, patch: ChannelBookmarkPatch, connectionId: string) => Promise<UpdateChannelBookmarkResponse>;
    ...
    getManagedCategories: (teamId: string) => Promise<Record<string, string>>;
    getPropertyFields: (groupName: string, objectType: string, targetType: string) => Promise<PropertyField[]>;
    getPropertyValues: <T>(groupName: string, objectType: string, targetId: string) => Promise<PropertyValue<T>[]>;
    ...
    getRemoteClusterInfo: (remoteId: string, includeDeleted?: boolean) => Promise<RemoteClusterInfo>;
    ...
    updateUserCustomProfileAttributesValues: (userID: string, attributeValues: Record<string, string | string[]>) => Promise<Record<string, string | string[]>>;
    ...
    getPost: (postId: string, includeDeleted?: boolean, retainContent?: boolean) => Promise<Post>;
    patchPost: (postPatch: PartialExcept<Post, "id">) => Promise<Post>;
    deletePost: (postId: string) => Promise<StatusOK>;
    revealBurnOnReadPost: (postId: string) => Promise<Post>;
    burnPostNow: (postId: string) => Promise<unknown>;
    ...
    getIncomingWebhooks: (teamId?: string, page?: number, perPage?: number, includeTotalCount?: boolean) => Promise<IncomingWebhooksWithCount | IncomingWebhook[]>;
    ...
    lookupInteractiveDialog: (data: DialogSubmission) => Promise<{
        items: Array<{
            text: string;
            value: string;
        }>;
    ...
    getJobsByType: (type: string, page?: number, perPage?: number, teamId?: string) => Promise<Job[]>;
    createJob: (job: JobTypeBase & {
        data?: any;
    }) => Promise<Job>;
    cancelJob: (id: string) => Promise<StatusOK>;
    createRecap: (request: CreateRecapRequest) => Promise<Recap>;
    getRecaps: (page?: number, perPage?: number) => Promise<Recap[]>;
    getRecap: (recapId: string) => Promise<Recap>;
    markRecapAsRead: (recapId: string) => Promise<Recap>;
    regenerateRecap: (recapId: string) => Promise<Recap>;
    deleteRecap: (recapId: string) => Promise<StatusOK>;
    ...
    getLLMServices: () => Promise<LLMService[]>;
    ...
    getGroupsByNames: (names: string[]) => Promise<Group[]>;
    ...
    getCloudPreviewModalData: () => Promise<PreviewModalContentData[]>;
    ...
    getAIRewrittenMessage: (agentId: string, message: string, action?: string, customPrompt?: string, rootId?: string) => Promise<string>;
    ...
    getAccessControlPolicy: (id: string, channelId?: string, teamId?: string) => Promise<AccessControlPolicy>;
    updateOrCreateAccessControlPolicy: (policy: AccessControlPolicy, teamId?: string) => Promise<AccessControlPolicy>;
    deleteAccessControlPolicy: (id: string, teamId?: string) => Promise<AccessControlPolicy>;
    ...
    getChannelsForAccessControlPolicy: (policyId: string, after: string, limit: number, teamId?: string) => Promise<AccessControlPolicyChannelsResult>;
    searchAccessControlPolicies: (term: string, type: string, after: string, limit: number, teamId?: string) => Promise<AccessControlPoliciesResult>;
    searchPermissionPolicies: (term: string, after: string, limit: number) => Promise<AccessControlPoliciesResult>;
    searchChildAccessControlPolicyChannels: (policyId: string, term: string, opts: ChannelSearchOpts, teamId?: string) => Promise<ChannelsWithTotalCount>;
    assignChannelsToAccessControlPolicy: (policyId: string, channelIds: string[], teamId?: string) => Promise<StatusOK>;
    unassignChannelsFromAccessControlPolicy: (policyId: string, channelIds: string[], teamId?: string) => Promise<StatusOK>;
    createAccessControlSyncJob: (jobData: {
        [key: string]: string;
    }) => Promise<Job>;
    getAccessControlFields: (after: string, limit: number, channelId?: string, teamId?: string) => Promise<UserPropertyField[]>;
    checkAccessControlExpression: (expression: string, channelId?: string, teamId?: string) => Promise<CELExpressionError[]>;
    testAccessControlExpression: (expression: string, term: string, after: string, limit: number, channelId?: string, teamId?: string) => Promise<AccessControlTestResult>;
    expressionToVisualFormat: (expression: string, channelId?: string, teamId?: string) => Promise<AccessControlVisualAST>;
    validateExpressionAgainstRequester: (expression: string, channelId?: string, teamId?: string) => Promise<{
        requester_matches: boolean;
    }>;
    getChannelAccessControlAttributes: (channelId: string) => Promise<AccessControlAttributes>;
    updateAccessControlPoliciesActive: (states: AccessControlPolicyActiveUpdate[], teamId?: string) => Promise<AccessControlPolicy[]>;
    getTeamContentFlaggingStatus: (teamId: string) => Promise<{
        enabled: boolean;
    }>;
    getContentFlaggingConfig: (teamId?: string) => Promise<ContentFlaggingConfig>;
    flagPost: (postId: string, reason: string, comment?: string) => Promise<StatusOK>;
    removeFlaggedPost: (postId: string, comment?: string) => Promise<StatusOK>;
    keepFlaggedPost: (postId: string, comment?: string) => Promise<StatusOK>;
